...
return [
    ...
    */
    ...
    'project_logo' => '<span >Dux HQ<img width="40px" style="margin-left:20px" src="' . '/packages/dux/duxtheme/img/dux_logo_icon.png' . '" alt="Dux Logo"></span>',
    ...
    */
    ...
    | https://www.backpackforlaravel.comheader_class
    |
    */
