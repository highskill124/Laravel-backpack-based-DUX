 ...
 */
class LocationPopupCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/locationpopup');
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->setCreateView('backpack::crud.locations.createpopup', $this->data);
    ...
    public function store(LocationRequest $request)
    {
        ...
        Alert::success("Location is Successfully Created! ")->flash();

        return redirect()->to('/admin/locationpopup/create');
    ...
    public function processFields($request)
    {
        ...
        $edit_location['is_open_monday']=$request["is_open_tuesday"];
    ...
    public function uploadPhoto(LocationRequest $request ) {
        ...
        $this->cleanDirectory('location/1');
    ...
    /**
     * remove all iamges files of a location storage
     * @param $path
