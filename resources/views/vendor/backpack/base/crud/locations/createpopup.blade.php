@extends(backpack_view('blank_popup'))
		  ...
		  <form method="post" action="{{ url($crud->route) }}"	enctype="multipart/form-data" id="location-form" >
             ...
             <div class="col-md-12">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="row" style="margin-left: 15px;padding: 5px;width: 75%;">
                                          <input   name="map_changed" class="form-check-input" type="checkbox" value="0" id="map_changed" >
                 ...
                 <button type="submit" class="btn btn-success">
                     ...
                     <span data-value="save_and_new">Save</span>
                 </button>
                 <button type="button" class="btn btn-danger"  onClick="javascript:window.close('','_parent','');" >
                     <span class="la la-close" role="presentation" aria-hidden="true"></span> &nbsp;
                     <span >Close</span>
                 </button>
